...
public class SpeechRecognizerManager {
    ...
    public SpeechRecognizerManager(Context context, onResultsReady listener)
    {
        ...
        mSpeechRecognizerIntent.putExtra(RecognizerIntent.EXTRA_LANGUAGE_MODEL, RecognizerIntent.ACTION_VOICE_SEARCH_HANDS_FREE);                           // get voice from bluetooth headset
        mSpeechRecognizerIntent.putExtra(RecognizerIntent.EXTRA_LANGUAGE, "th-TH");  // add Thai language
        ...
        if(!mIsListening)
        {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                ...
                if (!mIsStreamSolo && mMute) {
                    ...
                    //              mAudioManager.setStreamMute(AudioManager.STREAM_MUSIC, true);     // sound beep
